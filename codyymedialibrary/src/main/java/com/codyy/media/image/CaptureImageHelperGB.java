...
@TargetApi(9)
public class CaptureImageHelperGB implements CaptureImageHelper.CameraHelperImpl {
    ...
    @Override
    public void getCameraInfo(final int cameraId, final CaptureImageHelper.CameraInfo2 cameraInfo) {
