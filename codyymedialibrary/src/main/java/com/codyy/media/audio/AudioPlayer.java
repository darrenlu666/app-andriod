...
public class AudioPlayer {
    ...
    private void updateRuntime(int currentTime) {
        ...
        // its ok to show 00:00 in the UI
//        playbackStr.append(String.format("%02d:%02d", TimeUnit.MILLISECONDS.toMinutes((long) currentTime), TimeUnit.MILLISECONDS.toSeconds((long) currentTime) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes((long) currentTime))));
        playbackStr.append(formatTime((long) currentTime));
    ...
    private void setTotalTime() {
        ...
        if (totalDuration != 0) {
//            playbackStr.append(String.format("%02d:%02d", TimeUnit.MILLISECONDS.toMinutes((long) totalDuration), TimeUnit.MILLISECONDS.toSeconds((long) totalDuration) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes((long) totalDuration))));
            playbackStr.append(formatTime(totalDuration));
        }
     ...
     * to play audio using {@link com.codyy.media.audio.AudioPlayer}
     *
     ...
     *
     * @see com.codyy.media.audio.AudioPlayer#addOnPauseClickListener(android.view.View.OnClickListener)
     ****/
    ...
    public AudioPlayer setAduioName(TextView textView, String title) {
        mAudioName = textView;
        mAudioName.setText(title);
        return this;
    }
    ...
    /***
     * @deprecated Use {@link com.codyy.media.audio.AudioPlayer#setRuntimeView(android.widget.TextView)} and
     * {@link com.codyy.media.audio.AudioPlayer#setTotalTimeView(android.widget.TextView)} instead. <br/>
     ...
     *
     * @see com.codyy.media.audio.AudioPlayer#setTotalTimeView(android.widget.TextView)
     ****/
     ...
     *
     * @see com.codyy.media.audio.AudioPlayer#setRuntimeView(android.widget.TextView)
     ****/
     ...
     *
     * <br/>
     * This is the simplest way to get AudioPlayer working for you. If you are using the default
     * player provided by this method, calling method {@link com.codyy.media.audio.AudioPlayer#setPlayView(android.view.View)},
     * {@link com.codyy.media.audio.AudioPlayer#setPauseView(android.view.View)}, {@link com.codyy.media.audio.AudioPlayer#setSeekBar(android.widget.SeekBar)},
     * {@link com.codyy.media.audio.AudioPlayer#setPlaytime(android.widget.TextView)} will have no effect.
     *
     * <br/>
     * <br/>
...
*/
     ...
     * <p>
     * <p>
     * Call {@link #(android.content.Context, android.net.Uri, android.widget.SeekBar, android.view.View, android.view.View, android.widget.TextView)} before calling
     * {@link #play()}
     * </p>
     */
    public void release() {
