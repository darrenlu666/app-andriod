...
//        RequestCreator rq = null;
        if (mUrl != null) {
//            rq = p.load(mUrl);
//            targetImageView.setImageURI(Uri.parse(mUrl));
...
//                QualityInfo qualityInfo = imageInfo.getQualityInfo();
            ...
            DraweeController draweeController = Fresco.newDraweeControllerBuilder().setControllerListener(controllerListener).setUri(Uri.parse(mUrl)).build();
            targetImageView.setController(draweeController);
        } else if (mFile != null) {
