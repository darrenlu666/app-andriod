...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    private NoCameraListener mNoCameraListener;
    ...
    public void setNoCameraListener(NoCameraListener noCameraListener) {
        mNoCameraListener = noCameraListener;
    }
    ...
    public void notifyNoCamera(){
        if (mNoCameraListener != null) mNoCameraListener.onNoCamera();
    }

    public interface NoCameraListener {
        void onNoCamera();
    }
}
