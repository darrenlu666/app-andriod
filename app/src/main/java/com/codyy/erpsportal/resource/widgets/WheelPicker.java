...
public class WheelPicker extends LinearLayout {
     ...
     * format().
     */
    private static class TwoDigitFormatter implements WheelPicker.Formatter {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(WheelPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(WheelPicker view, @ScrollState int scrollState);
    }
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.DefaultWheelPicker);
    }
    ...
    public WheelPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final Drawable selectionDivider = attributesArray.getDrawable(
                R.styleable.WheelPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_minHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_maxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_minWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.WheelPicker_maxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.WheelPicker_virtualButtonPressedDrawable);
    ...
    private boolean moveToFinalScrollerPosition(Scroller scroller) {
        Log.d(TAG, "moveToFinalScrollerPosition");
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIgnoreMoveEvents) {
                    Log.d(TAG, "onTouchEvent Ignore ACTION_MOVE");
                    break;
                }
                float currentMoveY = event.getY();
                if (mScrollState != OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
                    Log.d(TAG, "onTouchEvent mScrollState not touch scroll");
                    int deltaDownY = (int) Math.abs(currentMoveY - mLastDownEventY);
                    if (deltaDownY > mTouchSlop) {
                        Log.d(TAG, "onTouchEvent deltaDownY > mTouchSlop");
                        removeAllCallbacks();
                        onScrollStateChange(OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
                    }
                } else {
                    Log.d(TAG, "onTouchEvent mScrollState touch scroll");
    ...
    public void scrollBy(int x, int y) {
        ...
        if (!mWrapSelectorWheel && y > 0
            ...
            Log.d(TAG, "scrollBy stop scroll up middleIndex="
                    + selectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]
                    + ",mMinValue = " + mMinValue);
        ...
        Log.d(TAG, "scrollBy mCurrentScrollOffset = " + mCurrentScrollOffset
                + ",mInitialScrollOffset=" + mInitialScrollOffset
                + ",mSelectorTextGapHeight=" + mSelectorTextGapHeight
                + ",mSelectorElementHeight=" + mSelectorElementHeight);
        while (mCurrentScrollOffset - mInitialScrollOffset > mSelectorTextGapHeight) {//当前
...
//            }
        ...
        Log.d(TAG, "-scrollBy end mCurrentScrollOffset = " + mCurrentScrollOffset);
    }
     ...
     * <p>
     * If the argument is less than the {@link WheelPicker#getMinValue()} and
     * {@link WheelPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link WheelPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link WheelPicker#getMinValue()} and
     * {@link WheelPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link WheelPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link WheelPicker#getMaxValue()} and
     * {@link WheelPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link WheelPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link WheelPicker#getMinValue()} and
     * {@link WheelPicker#getMaxValue()} values.
     * <p>
    ...
    private void initializeSelectorWheel() {
        ...
        mCurrentScrollOffset = mInitialScrollOffset;
        Log.d(TAG, "initializeSelectorWheel mCurrentScrollOffset=" + mCurrentScrollOffset);
        updateInputTextView();
    }
    ...
    private void incrementSelectorIndices(int[] selectorIndices) {
        Log.d(TAG, "incrementSelectorIndices before" + Arrays.toString(selectorIndices));
        ...
        Log.d(TAG, "incrementSelectorIndices after" + Arrays.toString(selectorIndices));
    ...
    private void decrementSelectorIndices(int[] selectorIndices) {
        Log.d(TAG, "decrementSelectorIndices before" + Arrays.toString(selectorIndices));
        ...
        Log.d(TAG, "decrementSelectorIndices after" + Arrays.toString(selectorIndices));
        ensureCachedScrollSelectorValue(nextScrollSelectorIndex);
    }
    ...
    private void ensureCachedScrollSelectorValue(int selectorIndex) {
        Log.d(TAG, "+ensureCachedScrollSelectorValue selectorIndex=" + selectorIndex);
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            WheelPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            WheelPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                WheelPicker.this.postDelayed(this,
