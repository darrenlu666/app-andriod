    ...
    private OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(int position) {
            ...
            if (object instanceof Video){
                ...
                VideoDetailsActivity.start(ClassResourcesActivity.this, mUserInfo, video.getId(), mClassId);
            } else if (object instanceof Audio) {
                List<Audio> audios = mAdapter.getData();
                AudioDetailsActivity.startFromClass(ClassResourcesActivity.this, mUserInfo, audios, position, mClassId);
            } else if (object instanceof Document) {
                Document document = (Document) object;
                DocumentContentActivity.start(ClassResourcesActivity.this, mUserInfo, document);
            } else if (object instanceof Image) {
                Image image = (Image) object;
                ImageDetailsActivity.start(ClassResourcesActivity.this, mUserInfo, image.getId());
            }
        }
    };
        ...
        mFilterTypeMenuController = new Builder().setActivity(this)
                ...
                .setOnMenuClickListener(new OnMenuClickListener() {
                    ...
                    public void onKnowledgeBtnClick() {
                        ResourceKnowledgeFilterAct.startForResult(ClassResourcesActivity.this, new AreaInfo(mUserInfo));
                    }
                })
                .build();
...
//            return true;
    ...
    public static void start(Context context, UserInfo userInfo, String classId) {
        Intent intent = new Intent(context, ClassResourcesActivity.class);
