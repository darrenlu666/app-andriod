...
public class StringUtils {
     ...
     * @return
     */
    public static String replaceHtml2(String str1) {
        return str1.replaceAll("<", "&lt;").replaceAll(">", "&gt;")
                .replaceAll("'","&#39;");
    }

    /**
     * 对url中的特殊字符进行摘除后进行URL编码，
     * 编码后重新组合.
     * @param str1
     * @return
     */
    public static String urlEncode(String str1){
        if(str1.contains("<") || str1.contains(">") || str1.contains("'")){
            String tag = "<";
            int index = str1.indexOf(tag);

            if(index <0){
                tag = ">" ;
                index = str1.indexOf(tag);
            }
            ...
            if(index>0){
                ...
                if((index+1)<=str1.length()){
                    ...
                    s2 = str1.substring(index+1,str1.length());
                }
            }else{
                s1 = "";
                if((index+1)>=str1.length()){
     ...
     * @return
     */
    public static String replaceSmallPic(String str1) {
        return str1.replaceAll(".JPG", ".small.JPG");
    }
    ...
    *  <pre>
    ...
    public static String replaceMsg(String msg,String replaceChar) {
        String replaceResult="";
        Cog.d("---------xxxx1",msg);
       replaceResult= msg.replaceAll("/","");
        Cog.d("---------xxxx2",replaceResult);
    ...
    public static String md5StringFor(String text) {
        String hash = null;
        try {
    ...
    /**
     * 376
     * @param total ex:376 s
     * @return 00:06:16
     */
    public static String convertTime(int total){

        String h ="",m = "" ,s ="";

        h = convertTwoTime(total/60/60);
        m = convertTwoTime(total/60%60);
        s = convertTwoTime(total%60);

        return h+ ":" + m + ":" + s ;
    }

    public static String convertTwoTime(int time){
