...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setAverageTabs(isAverageTabs);
        if (bottomBorderPadding >= 0) {//小于0代表xml中没有设置底边padding，那就保持原来默认padding的。
            mTabStrip.setSelectedIndicatorPadding((int) bottomBorderPadding);
        }
    ...
    public void setAverageTabs(boolean isAverageTabs) {
        mTabStrip.setIsAverageTabs(isAverageTabs);
    }

    public void setMaxTabsWhenAveraged(int maxTabCount) {
        mTabStrip.setMaxTabsWhenAveraged(maxTabCount);
    }
...
//        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP);
        ...
        public void onClick(View v) {
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (v == mTabStrip.getChildAt(i)) {
                    ...
                    //notify the outsides tab clicked !
                    if (null != mTabListener) mTabListener.onClick(i, v);
                    return;
                }
            }
        }
    ...
    public void setTabListener(OnTabListener mTabListener) {
