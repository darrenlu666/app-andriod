...
public class PhotoDrawee extends SimpleDraweeView implements IAttacher {
    ...
    public PhotoDrawee(Context context) {
        super(context);
        init();
    }

    public PhotoDrawee(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PhotoDrawee(Context context, AttributeSet attrs, int defStyle) {
