...
//                createNotification();
    ...
    @SuppressLint("NewApi")
    private void handleFileUpload(final String uploadId, final String url, final String method, final ArrayList<FileToUpload> filesToUpload, final ArrayList<NameValue> requestHeaders,
                                  final ArrayList<NameValue> requestParameters, final String customUserAgent) throws IOException {
    ...
    private long getRequestParametersBytes(final ArrayList<NameValue> requestParameters, final long boundaryBytesLength)
    ...
    private void uploadFiles(final String uploadId, final OutputStream requestStream, final ArrayList<FileToUpload> filesToUpload, final byte[] boundaryBytes)
    ...
    private long
    getFileBytes(final ArrayList<FileToUpload> filesToUpload, long boundaryBytesLength) throws UnsupportedEncodingException {
        long total = 0;
