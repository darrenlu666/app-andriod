...
import com.codyy.erpsportal.commons.widgets.EmojiconTextView;
...
class EmojiAdapter extends ArrayAdapter<Emojicon> {
    ...
    public EmojiAdapter(Context context, List<Emojicon> data, int emojiHeight) {
        super(context, R.layout.v2_list_cell_emojicon_item, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView;
        if (v == null) {
            v = View.inflate(getContext(), R.layout.v2_list_cell_emojicon_item, null);
