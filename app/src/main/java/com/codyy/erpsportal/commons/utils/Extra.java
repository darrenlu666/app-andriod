...
/**
 * EXTRA KEYS
 * Created by gujiajia on 2016/5/30.
 */
public class Extra {
    public final static String USER_INFO = "com.codyy.erpsportal.USER_INFO";

    public final static String AREA_ID = "com.codyy.erpsportal.AREA_ID";
    ...
    public final static String AREA_INFO = "com.codyy.erpsportal.AREA_INFO";
