 ...
 */
public class MyBlogViewHolder extends BaseRecyclerViewHolder<BlogPost> {
    ...
    public void setData(int position,BlogPost data) {
        ...
        mCategoryTextView.setText(TextUtils.isEmpty(data.getCategoryName())?"未分类":data.getCategoryName());
        //create time
