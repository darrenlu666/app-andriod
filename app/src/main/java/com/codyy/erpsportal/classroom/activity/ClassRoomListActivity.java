...
public class ClassRoomListActivity extends ToolbarActivity implements ClassRoomListFragment.TodayClassCountListener {
    ...
    private void initViews() {
        mTitle.setText(ClassRoomContants.FROM_WHERE_MODEL.equals(ClassRoomContants.TYPE_CUSTOM_LIVE) ? Titles.sWorkspaceSpeclassLive : Titles.sWorkspaceNetClassLive);
        ClassRoomListFragment classRoomListFragment = ClassRoomListFragment.newInstance(getIntent().getStringExtra(ClassRoomContants.FROM_WHERE_MODEL));
