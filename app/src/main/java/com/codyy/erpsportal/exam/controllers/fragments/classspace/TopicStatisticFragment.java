...
public class TopicStatisticFragment extends ItemIndexBaseFragment {
    ...
    private void getData() {
        ...
        sender.sendRequest(new RequestSender.RequestData(URLConfig.SPACE_CLASS_QUESTION_STATISTIC, map, new Response.Listener<JSONObject>() {
            @Override
    ...
    protected void loadData() {
        mUpOrDownButton.setVisibility(View.GONE);
        getData();
    }
