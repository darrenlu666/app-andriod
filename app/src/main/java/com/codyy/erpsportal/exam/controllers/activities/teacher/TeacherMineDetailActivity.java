 ...
 */
public class TeacherMineDetailActivity extends TaskActivity implements View.OnClickListener {
    private static final String TAG = TeacherMineDetailActivity.class.getSimpleName();
    ...
    private QuestionInfo getQuestionInfo(JSONObject o) {
        ...
        try {
            ...
            info.setQuestionResolveVideo(o.isNull("resolveVideoUrl")?"":o.getString("resolveVideoUrl"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_arrange:
                TeacherArrangeActivity.startActivity(this, getIntent().getStringExtra(EXTRA_EXAM_ID));
                break;
    ...
    public static void startActivity(Context from, String title, String id, boolean isArrange, int type, String url) {
        Intent intent = new Intent(from, TeacherMineDetailActivity.class);
