package com.codyy.erpsportal.exam.controllers.activities.parent;
 ...
 */
public class ParentViewCheckedActivity extends TaskActivity implements View.OnClickListener {
    private static final String TAG = ParentViewCheckedActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSubmit.setText(getString(R.string.exam_info));
    ...
    private static final String EXTRA_EXAM_PRACTICE_STATUS = ParentViewCheckedActivity.class.getPackage() + ".EXTRA_EXAM_PRACTICE_STATUS";

    public static void startActivity(Activity activity, String title, String examTaskId, String practiceStatus) {
        Intent intent = new Intent(activity, ParentViewCheckedActivity.class);
    ...
    protected String getUrl() {
        return URLConfig.PARENT_VIEW_CHECKED;
    }
