 ...
 */
public class ParentViewWaitActivity extends TaskActivity implements View.OnClickListener {
    private static final String TAG = ParentViewWaitActivity.class.getSimpleName();
    ...
    private QuestionInfo getQuestionInfo(JSONObject o) {
        ...
        try {
            ...
            try {
                ...
                try {
                    info.setQuestionCorrectAnswer(o.isNull("questionCorrectAnswer") ? builder.toString() : o.getString("questionCorrectAnswer"));
                } catch (Exception e) {
    ...
    protected String getUrl() {
        return URLConfig.PARENT_VIEW_SUBMIT;
    }
    ...
    public static void startViewWaitActivity(Context from, String title, String taskId, boolean isArrange, int type) {
        Intent intent = new Intent(from, ParentViewWaitActivity.class);
